...
import { LogOut, Users, Clock, FileText, BarChart3, Calendar, DollarSign, User, Menu, X, Megaphone, Network, Mail, MessageSquare, ImageIcon, Vote, Award, Gift } from 'lucide-react';
